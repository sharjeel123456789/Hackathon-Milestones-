document.addEventListener("DOMContentLoaded", function () {
    ...
    var addField = function (container, template) {
        var lastEntry = container.lastElementChild;
        var inputs = (lastEntry === null || lastEntry === void 0 ? void 0 : lastEntry.querySelectorAll("input, textarea")) || [];
        var isComplete = Array.from(inputs).every(function (input) { return input.value.trim() !== ""; });
        if (isComplete) {
            ...
            alert("Please complete the current entry before adding more.");
        }
    };
    ...
    form.addEventListener("submit", function (e) {
        ...
        var educations = Array.from(document.querySelectorAll("#education-section .education-entry"))
            .map(function (entry) {
        ...
        var experiences = Array.from(document.querySelectorAll("#experience-section .experience-entry"))
            .map(function (entry) {
            ...
            var responsibilities = entry.querySelector('[name="responsibilities"]').value;
